...
public class ViewModel extends Module {
    ...
    public final Setting<SettingGroup> mainHand = new Setting<>("MainHand", new SettingGroup(true, 0));
    ...
    public final Setting<SettingGroup> rotationMain = new Setting<>("Rotation", new SettingGroup(true, 1)).addToGroup(mainHand);
    ...
    public final Setting<SettingGroup> animateMain = new Setting<>("Animate", new SettingGroup(true, 1)).addToGroup(mainHand);
    ...
    public final Setting<SettingGroup> offHand = new Setting<>("OffHand", new SettingGroup(true, 0));
    ...
    public final Setting<SettingGroup> rotationOff = new Setting<>("RotationOff", new SettingGroup(true, 1)).addToGroup(offHand);
    ...
    public final Setting<SettingGroup> animateOff = new Setting<>("AnimateOff", new SettingGroup(true, 1)).addToGroup(offHand);
    ...
    public final Setting<SettingGroup> eatMod = new Setting<>("Eat", new SettingGroup(true, 0));
