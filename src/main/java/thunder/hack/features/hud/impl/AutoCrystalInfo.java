...
public class AutoCrystalInfo extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Target: " + Formatting.GRAY + "null", getPosX() + 113, getPosY() + 16, HudEditor.textColor.getValue().getRawColor());
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Calc delay: " + Formatting.GRAY + "0ms", getPosX() + 113, getPosY() + 24, HudEditor.textColor.getValue().getRawColor());
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Side: " + Formatting.GRAY + "null", getPosX() + 113, getPosY() + 32, HudEditor.textColor.getValue().getRawColor());
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Damage: " + Formatting.GRAY + "null", getPosX() + 113, getPosY() + 40, HudEditor.textColor.getValue().getRawColor());
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Self: " + Formatting.GRAY + "null", getPosX() + 113, getPosY() + 48, HudEditor.textColor.getValue().getRawColor());
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Overr. dmg: " + Formatting.GRAY + "null", getPosX() + 113, getPosY() + 56, HudEditor.textColor.getValue().getRawColor());
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Efficiency: " + Formatting.GRAY + "0", getPosX() + 113, getPosY() + 64, HudEditor.textColor.getValue().getRawColor());
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Pause: " + Formatting.GRAY + "false", getPosX() + 113, getPosY() + 72, HudEditor.textColor.getValue().getRawColor());
