...
public class HolyFacker implements ModInitializer {
    public static final ModMetadata MOD_META;

    public static final String MOD_ID = "holyfacker";
    ...
    public void onInitialize() {
        ...
        LOGGER.info("[HolyFacker] Init time: {} ms.", System.currentTimeMillis() - initTime);
        initTime = System.currentTimeMillis();
