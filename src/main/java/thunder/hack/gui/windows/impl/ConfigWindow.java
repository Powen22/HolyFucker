...
public class ConfigWindow extends WindowBase {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
        ...
        for (ConfigPlate configPlate : configPlates) {
            ...
            FontRenderers.sf_medium.drawString(context.getMatrices(), configPlate.name() + (Objects.equals(configPlate.name() + ".hf", Managers.CONFIG.currentConfig.getName()) ? blink : "")
